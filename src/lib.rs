...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TestSuite processing");
    
    let mut processor = TestSuiteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TestSuiteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TestSuiteProcessor::new(false);
